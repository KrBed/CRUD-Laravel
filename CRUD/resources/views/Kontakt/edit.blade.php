...
@section('title',"Edycja kontaktu")
@section('content')

<div class="container">
          <div class="card mt-5">
  <div class="card-header text-center font-weight-bold text-white" style="background-color:#005aab">
  <h3>Edycja kontaktu {{$contact->imie . " " . $contact->nazwisko}}</h3>
  </div>
  <div class="card-body font-weight-bold">
    <form method="POST" action="{{ route('kontakt.update', $contact->id) }}">
    <div class="row">
        <div class="form-group col-md-6">
            <label class="" for="imie">Imię: </label>
            <div class="">
                <input type="text" name='imie' class="form-control" value="{{$contact->imie}}">
                @if ($errors->has('imie'))
            ...
            @endif
              ...
              <div class="form-group col-md-6">
                ...
                <div class="">
                    <input type="text" name='nazwisko' class="form-control" value="{{$contact->nazwisko}}" >
              ...
              <div class="form-group col-md-6 ">
                ...
                <div class="">
                    <input type="text" name='firma' class="form-control" value="{{$contact->firma}}" >
                    @if ($errors->has('firma'))
              ...
              <div class="form-group col-md-6">
                ...
                <div class="">
                    <input type="text" name='oddzial' class="form-control" value="{{$contact->oddzial}}" >
              ...
              <div class="form-group col-md-6">
                ...
                <div class="">
                    <input type="text" name='dzial' class="form-control" value="{{$contact->dzial}}">
                    @if ($errors->has('dzial'))
              ...
              <div class="form-group col-md-6">
                ...
                <div class="">
                    <input type="text" name='stanowisko' class="form-control" value="{{$contact->stanowisko}}">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="">
                    <input type="text" name='telefonStacjonarny' class="form-control" value="{{$contact->telefonStacjonarny}}" >
              ...
              <div class="form-group col-md-6">
                ...
                <div class="">
                    <input type="text" name='telefonKomorkowy' class="form-control" value="{{$contact->telefonKomorkowy}}">
